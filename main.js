...
//or copy the codes
//© 2022 Arctix Bot Inc. 𝐀𝐑𝐂𝐓𝐈𝐗 𝐁𝐎𝐓
const {
    WAConnection,
    MessageType,
    Presence,
...
const starts = async (DogeXeonOP = new WAConnection()) => {
    ...
    console.log(color(figlet.textSync('𝐀𝐑𝐂𝐓𝐈𝐗 𝐁𝐎𝐓', {
		font: 'Standard',
...
console.log(color('  Xeon Bot Inc. 2022','mediumseagreen'))
    ...
    console.log(color('[𝐀𝐑𝐂𝐓𝐈𝐗 𝐁𝐎𝐓]'), color('Arctix Bot Is Online', 'aqua'))
    console.log(color('[DEV]', 'cyan'), color('Welcome Back Owner! Hope You Doing Well~', 'magenta'))
    console.log(color('<>','red'), color('Thanks For Using Arctix Bot', 'white'))
	DogeXeonOP.browserDescription = [ 'Subscribe Arctix', 'chrome', '3.0' ]
    DogeXeonOP.on('qr', () => {
    ...
    DogeXeonOP.sendMessage(`919875718817@s.whatsapp.net`, `Thanks bro, your bot is working on my whatsapp number ez😂`, MessageType.extendedText)
...
DogeXeonOP.on("group-participants-update", async (anu) => {
    ...
    try {
      ...
      try {
        ...
        DogeXeonOP.sendMessage(anu.jid, "Hello everyone, am 𝐀𝐑𝐂𝐓𝐈𝐗 𝐁𝐎𝐓, ready to help you here ㋛︎", "conversation")
      }
      ...
      welcomeButt = { contentText: `${teks}`, footerText: `𝐀𝐑𝐂𝐓𝐈𝐗 𝐁𝐎𝐓`, buttons: welcomeBut, headerType: 6, locationMessage: bosco2.message.locationMessage}
      ...
      goodbyeButt = { contentText: `${out}`, footerText: `𝐀𝐑𝐂𝐓𝐈𝐗 𝐁𝐎𝐓`, buttons: goodbyeBut, headerType: 6, locationMessage: bosco3.message.locationMessage}
